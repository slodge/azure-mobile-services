...
using SixSteps.UI.Touch.Views;

namespace SixSteps.UI.Touch
{
    public class SixStepsTabletPresenter
        ...
        , IMvxServiceConsumer<IMvxTouchViewCreator>
    {
        ...
        public SixStepsTabletPresenter(UIApplicationDelegate applicationDelegate, UIWindow window)
        {
