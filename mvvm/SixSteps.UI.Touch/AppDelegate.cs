...
namespace SixSteps.UI.Touch 
{
        ...
        , IMvxServiceConsumer<IMvxStartNavigation>
	{
		...
		public override bool FinishedLaunching (UIApplication app, NSDictionary options)
		{
            ...
            var presenter = 
				IsPad
                    ? (IMvxTouchViewPresenter)new SixStepsTabletPresenter(this, _window)
                    : (IMvxTouchViewPresenter)new SixStepsPhonePresenter(this, _window);
            */
            var presenter = new SixStepsPhonePresenter(this, _window);
